...
try {
    const rawData = fs.readFileSync('C:\\Users\\User\\.gemini\\antigravity\\brain\\3c7d0765-f260-4706-9350-b1865bb4644d\\.system_generated\\steps\\2226\\output.txt', 'utf8');
    const data = JSON.parse(rawData);

    let md = `# DataForSEO Keyword Analyse: Breite Head-Terms\n\n`;
    ...
    fs.writeFileSync('C:\\Users\\User\\.gemini\\antigravity\\brain\\3c7d0765-f260-4706-9350-b1865bb4644d\\broad_keyword_report.md', md);
